...
export function ButterflyExtensionsGuideView({ locale }: { locale: Locale }) {
  const c = butterflyExtensionsGuideContent[locale]

  return (
    <CartProvider>
      <BlogJsonLd slug="butterfly-extensions-guide" locale={locale} />
      <div className="flex min-h-screen flex-col">
        ...
        <main className="flex-1">
          ...
          <article className="max-w-4xl mx-auto px-4 md:px-6 py-16">
            ...
            <div className="prose prose-lg max-w-none">
              ...
              {/* ── Key Benefits ──────────────────────── */}
              <h2 className="font-serif text-3xl md:text-4xl font-medium mt-12 mb-6">{c.benefitsHeading}</h2>
        ...
        <BlogFaqSection slug="butterfly-extensions-guide" title={c.faqHeading} locale={locale} />
        <RelatedGuides slug="butterfly-extensions-guide" locale={locale} />
        <Footer />
        <CartDrawer />
      </div>
    </CartProvider>
